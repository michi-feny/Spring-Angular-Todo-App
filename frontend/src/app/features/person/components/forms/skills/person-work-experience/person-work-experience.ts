...
import { PersonWorkExperienceDto } from '../../../../../../types/dto/person/person-skill.dto';
  ...
  private createWorkExperienceGroup(item?: Partial<PersonWorkExperienceDto>): FormGroup {
    return this.fb.group({
      ...
      workExperience: this.fb.group({
        ...
        description: [item?.workExperience?.description ?? '', [Validators.maxLength(1000)]],
        ...
        company: this.fb.group({
          ...
          legalForm: [item?.workExperience?.company?.legalForm ?? '', [Validators.maxLength(50)]],
          address: this.fb.group({
            ...
            nationalityId: [item?.workExperience?.company?.address?.nationalityId ?? null]
          })
        })
      })
    });
