...
export class CustomValidators {
    ...
    //static equalsTo(matchTo: string, reverse: boolean = false, targetLabelKey?: string): ValidatorFn {
    //    return (control: AbstractControl): ValidationErrors | null => {
...
//
    ...
    //        if (!targetControl) {
    //            throw new Error(`equalsTo: Control with name "${matchTo}" not found in parent group.`);
    //        }
//
    //        const value = control.value;
...
//
    //        return isMatch 
    //            ? null 
    //            : { equalsTo: { expected: targetLabelKey?.toUpperCase() || matchTo } };
    //    };
    //}
