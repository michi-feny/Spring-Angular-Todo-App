package ibee.webapp.todo_app.features.person.related.country.controller;
...
public class PersonCountryController extends AbstractSpringPersonRelatedHateoasController<
    ...
    public PersonCountryController(
            PersonCountryDtoService service,
            TranslationService translationService,
            PersonCountryModelAssembler assembler) {
        
        super((PersonRelatedDtoService<PersonCountryDto, PersonCountry, PersonCountryId, PersonCountryDtoId>)service, translationService, assembler, "entity.personCountry");
    }
}
